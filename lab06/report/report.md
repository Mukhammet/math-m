...
![Графики численности в случае $I(0)\leq I^*$](https://github.com/Mukhammet/math-m/blob/master/lab06/image/01.png?raw=true){ #fig:001 width=70% height=70% }

![Графики численности в случае $I(0)>I^*$](https://github.com/Mukhammet/math-m/blob/master/lab06/image/02.png?raw=true){ #fig:002 width=70% height=70% }
