...
![График численности групп](https://github.com/Mukhammet/math-m/blob/master/lab06/image/01.png?raw=true){ #fig:001 width=70% height=70% }

## Графики изменения численности во втором случае

![График численности групп](https://github.com/Mukhammet/math-m/blob/master/lab06/image/02.png?raw=true){ #fig:002 width=70% height=70% }
