...
![Жесткая модель войны](https://github.com/Mukhammet/math-m/blob/master/lab03/image/01.png?raw=true){ #fig:001 width=70% height=70% }
...
![Фазовые траектории для второго случая](https://github.com/Mukhammet/math-m/blob/master/lab03/image/02.png?raw=true){ #fig:002 width=70% height=70% }
...
В начальный момент времени страна $X$ имеет армию численностью 400000 человек, а в распоряжении страны $Y$ армия численностью в 100000 человек.
...
![График численности для случая 1](https://github.com/Mukhammet/math-m/blob/master/lab03/image/image1.png?raw=true){ #fig:003 width=70% height=70% }
...
$$
 \begin{cases}
	\frac{dx}{dt}= -0.21x(t) - 0.7y(t) + sin(10t)
	\\
